...
export function OnboardingWizard() {
  ...
  async function runAdapterEnvironmentTest(
    ...
    if (!createdCompanyId) {
      setAdapterEnvError(
        "Adapter 환경 테스트 전에 회사를 생성하거나 선택하세요."
      );
      return null;
    }
              ...
              {step === 3 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">첫 번째 Agent 생성</h3>
                      <p className="text-xs text-muted-foreground">
                        이 Agent가 작업을 실행하는 방식을 선택하세요.
                      </p>
                    </div>
                  </div>
                  <div>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <div>
                          ...
                          <p className="text-[11px] text-muted-foreground">
                            Adapter CLI에 hello 응답을 요청하는 라이브 프로브를
                            실행합니다.
                          </p>
                        </div>
                        <Button
              ...
              {step === 4 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">할 일을 지정하세요</h3>
                      <p className="text-xs text-muted-foreground">
                        Agent에게 시작할 작은 작업을 주세요 -- 버그 수정,
                        리서치 질문, 스크립트 작성 등.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        모든 설정이 완료되었습니다. 지금 시작하면 시작 작업을
                        생성하고, Agent를 깨우고, Issue를 엽니다.
                      </p>
                    </div>
                  </div>
