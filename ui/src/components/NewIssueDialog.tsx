...
export function NewIssueDialog() {
  ...
  const createIssueErrorMessage =
    createIssue.error instanceof Error ? createIssue.error.message : "Issue 생성에 실패했습니다. 다시 시도해 주세요.";
        ...
        {currentProject && currentProjectSupportsExecutionWorkspace && (
          <div className="px-4 py-3 shrink-0 space-y-2">
            <div className="space-y-1.5">
              <div className="text-xs font-medium">실행 Workspace</div>
              <div className="text-[11px] text-muted-foreground">
                이 Issue가 공유 Workspace, 새 격리 Workspace, 또는 기존 Workspace에서 실행될지 제어합니다.
              </div>
              <select
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? "생성 중..." : "Issue 생성"}</span>
              </span>
            </Button>
          </div>
        </div>
