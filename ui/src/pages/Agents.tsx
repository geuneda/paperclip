...
export function Agents() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Bot} message="Agent를 보려면 회사를 선택하세요." />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {filtered.length > 0 && (
        <p className="text-xs text-muted-foreground">Agent {filtered.length}개</p>
      )}
      ...
      {agents && agents.length === 0 && (
        <EmptyState
          icon={Bot}
          message="시작하려면 첫 번째 Agent를 생성하세요."
          action="새 Agent"
