      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            하위 Goal ({childGoals.length})
          </TabsTrigger>
          <TabsTrigger value="projects">
            Project ({linkedProjects.length})
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="children" className="mt-4 space-y-3">
          ...
          {childGoals.length === 0 ? (
            <p className="text-sm text-muted-foreground">하위 Goal이 없습니다.</p>
          ) : (
        ...
        <TabsContent value="projects" className="mt-4">
          {linkedProjects.length === 0 ? (
            <p className="text-sm text-muted-foreground">연결된 Project가 없습니다.</p>
          ) : (
